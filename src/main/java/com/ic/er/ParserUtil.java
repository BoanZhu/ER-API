...
public class ParserUtil {
    ...
    public static View parseAttributeToRelationship(List<TableDTO> tableDTOList) throws ParseException {
        ...
        View view = new View((long)1, "unknown", entityList, relationshipList, "unknown", null, null);
        return view;
    }
